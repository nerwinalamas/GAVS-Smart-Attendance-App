...
import com.example.gavssmartattendanceapp.adapters.AppointmentroomAdapter;
...
public class AppointmentRoomActivity extends AppCompatActivity {
    ...
    AppointmentroomAdapter createAdapter3;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_appointmentroom);
        ...
        createAdapter3 = new AppointmentroomAdapter(appointmentsList);
        recyclerView3.setAdapter(createAdapter3);
        recyclerView3.setLayoutManager(new LinearLayoutManager(AppointmentRoomActivity.this));

        createAdapter3.setOnItemClickListener3(this::gotoCRActivity);

        //Floating Button
        floatingActionButton3.setOnClickListener(v -> {
            final Dialog dialog = new Dialog(AppointmentRoomActivity.this);
        ...
        floatingActionButton4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(AppointmentRoomActivity.this, HealthDeclarationFormActivity.class);
                startActivity(i);
            }
        });
