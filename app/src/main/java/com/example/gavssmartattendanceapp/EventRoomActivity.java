...
import com.example.gavssmartattendanceapp.adapters.EventroomAdapter;
...
public class EventRoomActivity extends AppCompatActivity {
    ...
    private EventroomAdapter createAdapter2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eventroom);
...
//        storeDataInArrays();
        ...
        createAdapter2 = new EventroomAdapter(eventList);
        recyclerView2.setAdapter(createAdapter2);
        recyclerView2.setLayoutManager(new LinearLayoutManager(EventRoomActivity.this));

        createAdapter2.setOnItemClickListener2(this::gotoCEActivity);

        //Floating Button
        floatingActionButton2.setOnClickListener(v -> {
            final Dialog dialog = new Dialog(EventRoomActivity.this);
